...
class Runner(AbstractEnvRunner):
    ...
    def run(self):
        ...
        mb_obs, mb_rewards, mb_actions, mb_values, mb_dones, mb_neglogpacs, mb_h, mb_sigma = [],[],[],[],[],[],[],[]
        ...
        for _ in range(self.nsteps):
            ...
            actions, values, self.states, neglogpacs, h, sigma = self.model.step(self.obs, S=self.states, M=self.dones)
        ...
        ### compute H    H is vector, so i mean it to a number.
        ...
        mb_hs = np.zeros_like(mb_rewards)
        lastgaelam = 0
        lasthlam = 0

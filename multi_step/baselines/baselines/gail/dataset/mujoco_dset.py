...
def tst(expert_path, traj_limitation, plot):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--expert_path", type=str, default="/home/zhiwei/rl_algorithm/multi_step/baselines/data/deterministic.trpo.Hopper.0.00.npz")
    parser.add_argument("--traj_limitation", type=int, default=None)
    parser.add_argument("--plot", type=bool, default=False)
    args = parser.parse_args()
    tst(args.expert_path, args.traj_limitation, args.plot)
